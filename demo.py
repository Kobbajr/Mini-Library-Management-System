...
# ADDING BOOKS
print("=== ADDING BOOKS ===")
print(add_book("111", "software engineering", "Mr Santigie kamara", "Fiction", 3))
print(add_book("222", "A Brief History of Technology", "Elon Musk", "Non-Fiction", 2))
print(add_book("333", "Dune", "Charles Darwin", "Sci-Fi", 4))
print(add_book("111", "Duplicate Book", "Someone", "Fiction", 1))
print(add_book("444", "Unknown Genre Book", "Author X", "Fantasy", 2))

# ADDING MEMBERS
print("\n=== ADDING MEMBERS ===")
print(add_member(1, "kobba", "sahrkobba808@gmail.com"))
